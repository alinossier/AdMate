...
+ (NSMutableCharacterSet * _Nonnull)wwwFormURLPlusSpaceCharacterSet;
@end
...
- (nonnull instancetype)initWithURL:(NSURL * _Nonnull)URL cachePolicy:(NSURLRequestCachePolicy)cachePolicy timeoutInterval:(NSTimeInterval)timeoutInterval OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, strong) NSURL * _Nullable startURL;

/// The URL string to intercept and respond to.
@property (nonatomic, copy) NSString * _Nullable interceptURLString;
@property (nonatomic, strong) NSURLComponents * _Nullable interceptComponents;
...
@property (nonatomic, copy) BOOL (^ _Nullable onIntercept)(NSURL * _Nonnull url);
